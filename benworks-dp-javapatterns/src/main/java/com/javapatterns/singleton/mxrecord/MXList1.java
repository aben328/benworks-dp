...
public class MXList1 {
	...
	private MXList1(String providerUrl, String domainName) throws Exception {
	...
	public static synchronized MXList1 getInstance(String providerUrl, String domainName) throws Exception {
		if (mxl == null) {
	...
	private Vector getMXRecords(String providerUrl, String domainName) throws Exception {
		...
		Attributes attrs = dirContext.getAttributes(domainName, new String[] { MX_PREFIX });
